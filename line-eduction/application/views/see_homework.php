...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-content-wrapper">
        ...
        <table class="table table-hover" style="width: 700px; margin: 0 150px">
            <?php foreach($homeworks as $result){ ?>
                <tr>
                    <th><a href="student/see_home_content?id=<?php echo $result->home_Id?>"><?php echo $result->home_Name?></a></th>
                    <th><?php echo $result->home_Start?></th>
                    <th><?php echo $result->home_End?></th>
                    <th><a href="student/see_home_content?id=<?php echo $result->home_Id?>">查看</a></th>
                </tr>
            <?php }?>
        </table>
    </div>
